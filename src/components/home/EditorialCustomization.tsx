...
export const EditorialCustomization: React.FC = () => {
  ...
  const altText = editorial.imageAlt || 'Woman wearing customized Moodifys streetwear T-shirt'
  ...
  return (
    <section className="relative w-full bg-[#E1E0DC]/40 py-16 md:py-24 border-b border-[#BEBDBB]/50 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            ...
            <div className="space-y-2">
              ...
              <h2 className="editorial-section-title text-[#090808] uppercase leading-[0.92] tracking-tighter">
                {renderHeadline()}
              </h2>
            </div>

            {editorial.description && (
              <p className="text-sm md:text-base text-[#302F2E] font-light leading-relaxed max-w-md">
                {editorial.description}
              </p>
            )}
            ...
            {(showPrimaryBtn || showSecondaryBtn) && (
              <div className="pt-2 flex flex-col sm:flex-row items-start sm:items-center gap-4">
                {showPrimaryBtn && (
                  <Link to={editorial.primaryCtaLink || '/customize'}>
                ...
                {showSecondaryBtn && (
                  <Link to={editorial.secondaryCtaLink || '/shop'}>
          ...
          <div className="lg:col-span-7 relative">
            <div className="relative aspect-16/11 sm:aspect-16/10 overflow-hidden bg-[#BEBDBB] border border-[#BEBDBB] shadow-xl group">
              <picture>
              ...
              {/* Floating archival white label */}
              {isLabelEnabled && (
                <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur-md px-4 py-2 text-[11px] font-mono font-bold tracking-widest text-[#090808] uppercase border border-black/10 shadow-md">
